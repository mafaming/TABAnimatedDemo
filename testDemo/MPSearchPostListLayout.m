...
/** 每一列之间的间距 */
static const CGFloat EWDefaultColumnMargin = 4;
/** 每一行之间的间距 **/
static const CGFloat EWDefaultFRowMargin = 4;
/** 内边距 */
static const UIEdgeInsets EWDefaultEdgeInsets = {4,4,4,4};

@interface MPSearchPostListLayout ()
/** 存放所有的布局属性 */
...
@implementation MPSearchPostListLayout
#pragma mark 懒加载
